...
;; (define-fun Tf_upper ((l Real) (u Real)) Real (max u (f l)))
;; ; problem 1
...
;; (define-fun Tf_lower ((l Real) (u Real)) Real (f l))
;; (define-fun Tf_upper ((l Real) (u Real)) Real (f u))
;; ; problem 2
...
;; (define-fun Tf_lower ((l Real) (u Real)) Real (f l))
;; (define-fun Tf_upper ((l Real) (u Real)) Real (+ u u))
; problem 3
...
;; (define-fun Tf_upper ((l Real) (u Real)) Real (max (* l l) (* (max (* u u) u) u)))
;; ; problem 5
